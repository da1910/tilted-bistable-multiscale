...
for eta in etas:
    ...
    create_output_file(
        os.path.join(template_dir, "raw.f90"),
    ...
    os.chdir(temp_dir)
    p = subprocess.Popen(
        ["auto", "hompdf.auto"], stdout=subprocess.PIPE, stderr=subprocess.PIPE
    )
    p.wait()
    os.chdir("../")
    ...
    for output_file in OUTPUT_FILES:
        os.rename(
            ...
            os.path.join(auto_output_dir, escaped_folder_name, output_file),
        )
